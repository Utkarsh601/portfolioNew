                ...
                <div key={index} className='mb-8 flex flex-wrap lg:justify-center'>
                    ...
                    className='w-full max-w-xl lg:w-3/4'>
                        <h6 className='mb-2 font-semibold'>
                            {expierence.role} - <span className='text-sm text-purple-100'>{expierence.company}</span>
                        </h6>
                        <p className='mb-4 text-neutral-400 '>{expierence.description}</p>
                        {expierence.technologies.map((tech,index)=>(
