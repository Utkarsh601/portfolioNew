...
import profilePic from '../assets/utkarshprofile.jpg'
import { motion } from "framer-motion"

const container = (delay) => ({
    hidden:{x:-100 , delay:0},
    visible:{
        x:0,
        opacity:1,
  ...
  return (
        ...
        <div className='w-full lg:w-1/2'>
            <div className='flex flex-col items-center lg:items-start'>
                ...
                animate = "visible"
                 ...
                 className='pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl'>Utkarsh Mishra</motion.h1>
                <motion.span 
    ...
    <div className='w-full lg:w-1/2 lg:p-8 '>
        <div className='flex justify-center'>
            <motion.img className='w-30 h-50 rounded-2xl' 
